...
import penta_1 from '../assets/penta_1.ogg';
import penta_2 from '../assets/penta_2.ogg';
import penta_3 from '../assets/penta_3.ogg';
import penta_4 from '../assets/penta_4.ogg';
import penta_5 from '../assets/penta_5.ogg';
import penta_6 from '../assets/penta_6.ogg';
import level_win from '../assets/level_win.ogg';
import color_in from '../assets/color_in.ogg';
import sound_ant from '../assets/word_ant.ogg';
import sound_axe from '../assets/word_axe.ogg';
import sound_man from '../assets/word_man.ogg';
import sound_bag from '../assets/word_bag.ogg';
import sound_bed from '../assets/word_bed.ogg';
import sound_box from '../assets/word_box.ogg';
import sound_cup from '../assets/word_cup.ogg';
import sound_cat from '../assets/word_cat.ogg';
import sound_car from '../assets/word_car.ogg';
import sound_dad from '../assets/word_dad.ogg';
import sound_dig from '../assets/word_dig.ogg';
import sound_dog from '../assets/word_dog.ogg';
import sound_ear from '../assets/word_ear.ogg';
import sound_egg from '../assets/word_egg.ogg';
import sound_end from '../assets/word_end.ogg';
import sound_fan from '../assets/word_fan.ogg';
import sound_far from '../assets/word_far.ogg';
import sound_fun from '../assets/word_fun.ogg';
import sound_gap from '../assets/word_gap.ogg';
import sound_get from '../assets/word_get.ogg';
import sound_god from '../assets/word_god.ogg';
import sound_him from '../assets/word_him.ogg';
import sound_hot from '../assets/word_hot.ogg';
import sound_hut from '../assets/word_hut.ogg';
import sound_if from '../assets/word_if.ogg';
import sound_in from '../assets/word_in.ogg';
import sound_it from '../assets/word_it.ogg';
import sound_jet from '../assets/word_jet.ogg';
import sound_job from '../assets/word_job.ogg';
import sound_joy from '../assets/word_joy.ogg';
import sound_key from '../assets/word_key.ogg';
import sound_kin from '../assets/word_kin.ogg';
import sound_kit from '../assets/word_kit.ogg';
import sound_leg from '../assets/word_leg.ogg';
import sound_lip from '../assets/word_lip.ogg';
import sound_log from '../assets/word_log.ogg';
import sound_map from '../assets/word_map.ogg';
import sound_mop from '../assets/word_mop.ogg';
import sound_net from '../assets/word_net.ogg';
import sound_new from '../assets/word_new.ogg';
import sound_nut from '../assets/word_nut.ogg';
import sound_off from '../assets/word_off.ogg';
import sound_on from '../assets/word_on.ogg';
import sound_ox from '../assets/word_ox.ogg';
import sound_pan from '../assets/word_pan.ogg';
import sound_pen from '../assets/word_pen.ogg';
import sound_pig from '../assets/word_pig.ogg';
import sound_queen from '../assets/word_queen.ogg';
import sound_question from '../assets/word_question.ogg';
import sound_quit from '../assets/word_quit.ogg';
import sound_rat from '../assets/word_rat.ogg';
import sound_red from '../assets/word_red.ogg';
import sound_run from '../assets/word_run.ogg';
import sound_sad from '../assets/word_sad.ogg';
import sound_sit from '../assets/word_sit.ogg';
import sound_sun from '../assets/word_sun.ogg';
import sound_tea from '../assets/word_tea.ogg';
import sound_top from '../assets/word_top.ogg';
import sound_two from '../assets/word_two.ogg';
import sound_under from '../assets/word_under.ogg';
import sound_up from '../assets/word_up.ogg';
import sound_us from '../assets/word_us.ogg';
import sound_van from '../assets/word_van.ogg';
import sound_vase from '../assets/word_vase.ogg';
import sound_very from '../assets/word_very.ogg';
import sound_wax from '../assets/word_wax.ogg';
import sound_wet from '../assets/word_wet.ogg';
import sound_win from '../assets/word_win.ogg';
import sound_yellow from '../assets/word_yellow.ogg';
import sound_yes from '../assets/word_yes.ogg';
import sound_you from '../assets/word_you.ogg';
import sound_zebra from '../assets/word_zebra.ogg';
import sound_zero from '../assets/word_zero.ogg';
import sound_zoo from '../assets/word_zoo.ogg';
import sound_a_long from '../assets/sound_a_long.ogg';
import sound_a_short from '../assets/sound_a_short.ogg';
import sound_b_long from '../assets/sound_b_long.ogg';
import sound_b_short from '../assets/sound_b_short.ogg';
import sound_c_long from '../assets/sound_c_long.ogg';
import sound_c_short from '../assets/sound_c_short.ogg';
import sound_d_long from '../assets/sound_d_long.ogg';
import sound_d_short from '../assets/sound_d_short.ogg';
import sound_e_long from '../assets/sound_e_long.ogg';
import sound_e_short from '../assets/sound_e_short.ogg';
import sound_f_long from '../assets/sound_f_long.ogg';
import sound_f_short from '../assets/sound_f_short.ogg';
import sound_g_long from '../assets/sound_g_long.ogg';
import sound_g_short from '../assets/sound_g_short.ogg';
import sound_h_long from '../assets/sound_h_long.ogg';
import sound_h_short from '../assets/sound_h_short.ogg';
import sound_i_long from '../assets/sound_i_long.ogg';
import sound_i_short from '../assets/sound_i_short.ogg';
import sound_j_long from '../assets/sound_j_long.ogg';
import sound_j_short from '../assets/sound_j_short.ogg';
import sound_k_long from '../assets/sound_k_long.ogg';
import sound_k_short from '../assets/sound_k_short.ogg';
import sound_l_long from '../assets/sound_l_long.ogg';
import sound_l_short from '../assets/sound_l_short.ogg';
import sound_m_long from '../assets/sound_m_long.ogg';
import sound_m_short from '../assets/sound_m_short.ogg';
import sound_n_long from '../assets/sound_n_long.ogg';
import sound_n_short from '../assets/sound_n_short.ogg';
import sound_o_long from '../assets/sound_o_long.ogg';
import sound_o_short from '../assets/sound_o_short.ogg';
import sound_p_long from '../assets/sound_p_long.ogg';
import sound_p_short from '../assets/sound_p_short.ogg';
import sound_q_long from '../assets/sound_q_long.ogg';
import sound_q_short from '../assets/sound_q_short.ogg';
import sound_r_long from '../assets/sound_r_long.ogg';
import sound_r_short from '../assets/sound_r_short.ogg';
import sound_s_long from '../assets/sound_s_long.ogg';
import sound_s_short from '../assets/sound_s_short.ogg';
import sound_t_long from '../assets/sound_t_long.ogg';
import sound_t_short from '../assets/sound_t_short.ogg';
import sound_u_long from '../assets/sound_u_long.ogg';
import sound_u_short from '../assets/sound_u_short.ogg';
import sound_v_long from '../assets/sound_v_long.ogg';
import sound_v_short from '../assets/sound_v_short.ogg';
import sound_w_long from '../assets/sound_w_long.ogg';
import sound_w_short from '../assets/sound_w_short.ogg';
import sound_x_long from '../assets/sound_x_long.ogg';
import sound_x_short from '../assets/sound_x_short.ogg';
import sound_y_long from '../assets/sound_y_long.ogg';
import sound_y_short from '../assets/sound_y_short.ogg';
import sound_z_long from '../assets/sound_z_long.ogg';
import sound_z_short from '../assets/sound_z_short.ogg';

import BackgroundImage from '../assets/tracing-letters-bg-blue-lines.png';
    ...
    render() {
      return `
        ...
        */
        ...
        #letter_canvas_overlay_holder .intro_word {
            position: absolute;
            font-family: lara;
            font-size: 10vw;
        }
        #letter_canvas_overlay_holder .intro_word span.underlined {
            border-bottom: 4px solid #333;
        }

        #letter_canvas_overlay_holder .intro_word_1 {
            top:10%;
            left:10%;
        }
        #letter_canvas_overlay_holder .intro_letter {
            position: absolute;
            font-family: lara;
            font-size: 13vw;
        ...
        <div class="letter_view_holder">

            <!--
            <div class="level_select_screen">
                <input class="level_number" type="number" name="level_number" value="1" />
            ...
            <div id="letter_view">
                ...
                <div id="letter_canvas_overlay_holder">
                    <canvas id="letter_canvas_overlay"></canvas>
                </div>

                <div id="happy_spot_canvas_holder">
                    <canvas id="happy_spot_canvas"></canvas>
                </div>

                <div id="checkpoint_canvas_holder">
                    <canvas id="checkpoint_canvas"></canvas>
                </div>

                <div id="brush_canvas_holder">
                    <canvas id="brush_canvas"></canvas>
                </div>

                <div id="letter_canvas_holder">
                    <canvas id="letter_canvas"></canvas>
                </div>

                <div id="level_one_canvas_holder">
                    <canvas id="level_one_canvas"></canvas>
                </div>
      ...
      `  
        ...
        start() {
            ...
            this.pentaScale = [];
            this.pentaScale.push(penta_1);
            this.pentaScale.push(penta_2);
            this.pentaScale.push(penta_3);
            this.pentaScale.push(penta_4);
            this.pentaScale.push(penta_5);
            this.pentaScale.push(penta_6);
            this.letter_win_sound = level_win;
            this.scaleCounter = 0;
    
            this.color_in_audio = color_in;
            ...
            this.checkpoints = [
                {
                    ...
                    wordSounds: [sound_ant, sound_axe, sound_man],
                    words: ['ant', 'axe', 'man'],
                    sounds: [sound_a_long, sound_a_short]
                },
                {
                    letter: 'b',
                    ...
                    wordSounds: [sound_bag, sound_bed, sound_box],
                    words: ['bag', 'bed', 'box'],
                    sounds: [sound_b_long, sound_b_short]
                },
                {
                    letter: 'c',
                    ...
                    wordSounds: [sound_cup, sound_cat, sound_car],
                    words: ['cup', 'cat', 'car'],
                    sounds: [sound_c_long, sound_c_short]
                },
                {
                    letter: 'd',
                    ...
                    wordSounds: [sound_dad, sound_dig, sound_dog],
                    words: ['dad', 'dig', 'dog'],
                    sounds: [sound_d_long, sound_d_short]
                },
                {
                    letter: 'e',
                    ...
                    wordSounds: [sound_ear, sound_egg, sound_end],
                    words: ['ear', 'egg', 'end'],
                    sounds: [sound_e_long, sound_e_short]
                },
                {
                    letter: 'f',
                    ...
                    wordSounds: [sound_fan, sound_far, sound_fun],
                    words: ['fan', 'far', 'fun'],
                    sounds: [sound_f_long, sound_f_short]
                },
                {
                    letter: 'g',
                    ...
                    wordSounds: [sound_gap, sound_get, sound_god],
                    words: ['gap', 'get', 'god'],
                    sounds: [sound_g_long, sound_g_short]
                },
                {
                    letter: 'h',
                    ...
                    wordSounds: [sound_him, sound_hot, sound_hut],
                    words: ['him', 'hot', 'hut'],
                    sounds: [sound_h_long, sound_h_short]
                }, 
                {
                    letter: 'i',
                    ...
                    wordSounds: [sound_if, sound_in, sound_it],
                    words: ['if', 'in', 'it'],
                    sounds: [sound_i_long, sound_i_short]
                },
                {
                    letter: 'j',
                    ...
                    wordSounds: [sound_jet, sound_job, sound_joy],
                    words: ['jet', 'job', 'joy'],
                    sounds: [sound_j_long, sound_j_short]
                },
                {
                    letter: 'k',
                    ...
                    wordSounds: [sound_key, sound_kin, sound_kit],
                    words: ['key', 'kin', 'kit'],
                    sounds: [sound_k_long, sound_k_short]
                },
                {
                    letter: 'l',
                    ...
                    wordSounds: [sound_leg, sound_lip, sound_log],
                    words: ['leg', 'lip', 'log'],
                    sounds: [sound_l_long, sound_l_short]
                },
                {
                    letter: 'm',
                    ...
                    wordSounds: [sound_man, sound_map, sound_mop],
                    words: ['man', 'map', 'mop'],
                    sounds: [sound_m_long, sound_m_short]
                },
                {
                    letter: 'n',
                    ...
                    wordSounds: [sound_net, sound_new, sound_nut],
                    words: ['net', 'new', 'nut'],
                    sounds: [sound_n_long, sound_n_short]
                },
                {
                    letter: 'o',
                    ...
                    wordSounds: [sound_off, sound_on, sound_ox],
                    words: ['off', 'on', 'ox'],
                    sounds: [sound_o_long, sound_o_short]
                },
                {
                    letter: 'p',
                    ...
                    wordSounds: [sound_pan, sound_pen, sound_pig],
                    words: ['pan', 'pen', 'pig'],
                    sounds: [sound_p_long, sound_p_short]
                },
                {
                    letter: 'q',
                    ...
                    wordSounds: [sound_queen, sound_question, sound_quit],
                    words: ['queen', 'question', 'quit'],
                    sounds: [sound_q_long, sound_q_short]
                },
                {
                    letter: 'r',
                    ...
                    wordSounds: [sound_rat, sound_red, sound_run],
                    words: ['rat', 'red', 'run'],
                    sounds: [sound_r_long, sound_r_short]
                },
                {
                    letter: 's',
                    ...
                    wordSounds: [sound_sad, sound_sit, sound_sun],
                    words: ['sad', 'sit', 'sun'],
                    sounds: [sound_s_long, sound_s_short]
                },
                {
                    letter: 't',
                    ...
                    wordSounds: [sound_tea, sound_top, sound_two],
                    words: ['tea', 'top', 'two'],
                    sounds: [sound_t_long, sound_t_short]
                },
                {
                    letter: 'u',
                    ...
                    wordSounds: [sound_under, sound_up, sound_us],
                    words: ['under', 'up', 'us'],
                    sounds: [sound_u_long, sound_u_short]
                },
                {
                    letter: 'v',
                    ...
                    wordSounds: [sound_van, sound_vase, sound_very],
                    words: ['van', 'vase', 'very'],
                    sounds: [sound_v_long, sound_v_short]
                ...
                },
                {
                    ...
                    wordSounds: [sound_wax, sound_wet, sound_win],
                    words: ['wax', 'wet', 'win'],
                    sounds: [sound_w_long, sound_w_short]
                },
                {
                    letter: 'x',
                    ...
                    wordSounds: [sound_axe, sound_box, sound_wax],
                    words: ['axe', 'box', 'wax'],
                    sounds: [sound_x_long, sound_x_short]
                },
                {
                    letter: 'y',
                    ...
                    wordSounds: [sound_yellow, sound_yes, sound_you],
                    words: ['yellow', 'yes', 'you'],
                    sounds: [sound_y_long, sound_y_short]
                },
                {
                    letter: 'z',
                    ...
                    wordSounds: [sound_zebra, sound_zero, sound_zoo],
                    words: ['zebra', 'zero', 'zoo'],
                    sounds: [sound_z_long, sound_z_short]
                }
            ]
    
            this.letterSoundAssets = {};
            this.letterSoundAssets.words = [];
            this.letterSoundAssets.wordSounds = [];
        ...
        addLetterSoundAssets() {
            ...
            this.checkpoints[this.currentletterIndex].words.forEach((word,i) => {
                this.letterSoundAssets.words.push(word);
            });
            // sounds
            this.checkpoints[this.currentletterIndex].wordSounds.forEach((sound,i) => {
                this.letterSoundAssets.wordSounds.push(sound);
            });

            this.checkpoints[this.currentletterIndex].sounds.forEach((sound,i) => {
                this.letterSoundAssets.sounds.push(sound);
            });
        }
        ...
        showIntroWord(word_index,letter,word,x,y) {
            ...
            this.playSound(this.letterSoundAssets.wordSounds[word_index]);
        }
